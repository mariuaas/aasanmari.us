---
title: "4096 Shades of Octahedra"
description: "Some ramblings on color quantization, compression, and aesthetics."
pubDate: 2026-01-28
draft: false
---
...
## Octahedral Quantized Color Palette

<div class="not-prose">
  <div id="sobolquantizer-app"></div>
</div>

<script type="module">
  import { mount } from "/sobolquantizer.js";

  const element = document.getElementById("sobolquantizer-app");
